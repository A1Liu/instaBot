...
/**
 * Utility methods for the bot. I could totally move more stuff here.
 * @author aliu
 *
 */
class Util {
	...
	/**
	 * Returns the following sibling of the specified element, or null if it doesn't exist. Loops to make sure the next element has time to load.
	 * @param elem the element to get the sibling of
	 * @return the following sibling of the specified element with the same tag
	 */
	static WebElement getNextLoop(WebElement elem) {
		...
		if (elem2 == null) throw new TimeoutException("Feed page took too long to load another post.");
		return elem2;
	}
